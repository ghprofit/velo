            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1">{stats.activeCreators} active / {stats.inactiveCreators} inactive</p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <div>
                  <p className="text-3xl font-bold text-gray-900 mb-1">${stats.creatorEarnings.toLocaleString()}</p>
