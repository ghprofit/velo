          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
            ...
            <div className="sm:col-span-2 lg:col-span-1 bg-linear-to-br from-green-500 to-green-600 rounded-xl shadow-lg p-4 sm:p-6 text-white">
              ...
              <button
                ...
                className="w-full bg-white text-green-600 px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg font-semibold hover:bg-green-50 transition-colors flex items-center justify-center gap-2 text-sm sm:text-base"
              >
