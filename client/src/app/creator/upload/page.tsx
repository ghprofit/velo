  ...
  return (
    <>
      ...
      <div className="bg-white border-b border-gray-200 px-8 py-6">
        ...
        <p className="text-gray-600">Follow the steps to upload, price, and share your exclusive content.</p>
      </div>
            ...
            {STEPS.map((step, index) => (
              <div key={step.number} className="flex items-center">
                ...
                {index < STEPS.length - 1 && (
                  <div className={`flex-1 h-0.5 mx-4 ${currentStep > step.number ? 'bg-indigo-600' : 'bg-gray-200'}`} />
                )}
              </div>
            ))}
          </div>
      ...
      <div className="p-8">
        <div className="max-w-3xl mx-auto">
          ...
          {currentStep === 1 && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h2 className="text-xl font-semibold text-gray-900">Step 1: Upload Your Content</h2>
                  <p className="text-gray-600 mt-1">Drag and drop or browse to upload your files</p>
                </div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                    {uploadedFiles.map((uf) => (
                      <div key={uf.id} className="relative group">
                        ...
                        <p className="mt-2 text-xs text-gray-600 truncate">{uf.file.name}</p>
          ...
          {currentStep === 2 && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <div className="mb-6">
                <h2 className="text-xl font-semibold text-gray-900">Step 2: Content Details</h2>
                <p className="text-gray-600 mt-1">Give your content a title, description, and set your price</p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900">{uploadedFiles.length} file{uploadedFiles.length > 1 ? 's' : ''} uploaded</p>
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-2">You'll receive 80% of the sale price after platform fees.</p>
                </div>
              </div>
              ...
              <div className="flex justify-between pt-6 mt-6 border-t border-gray-200">
                <button
                  ...
                  className="px-6 py-2.5 border border-gray-300 text-gray-700 hover:bg-gray-50 rounded-lg font-medium transition-colors flex items-center gap-2"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {currentStep === 3 && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <div className="mb-6">
                <h2 className="text-xl font-semibold text-gray-900">Step 3: Generate Your Unique Link</h2>
                <p className="text-gray-600 mt-1">Review your content and generate a unique, trackable link</p>
              </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 mt-3">
                      <span className="text-2xl font-bold text-indigo-600">${parseFloat(price).toFixed(2)}</span>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      A short, unique URL like <code className="bg-white px-2 py-0.5 rounded text-indigo-600">velo.link/c/abc123xyz</code> that:
                    </p>
              ...
              <div className="flex justify-between pt-4 border-t border-gray-200">
                ...
                <button
                  ...
                  disabled={uploading}
                  className="px-8 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white rounded-lg font-semibold transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 shadow-lg shadow-indigo-500/25"
                >
                  {uploading ? (
                    <>
          ...
          {currentStep === 4 && (
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200 rounded-xl p-6 text-center">
                ...
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Your Link is Ready!</h2>
                <p className="text-gray-600">Share it anywhere to start earning</p>
              </div>

              {/* Generated Link Card */}
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Your Unique Content Link</h3>

                <div className="bg-indigo-50 rounded-lg p-4 flex items-center justify-between gap-4 mb-4">
                  <div className="flex items-center gap-3 flex-1 min-w-0">
                    ...
                    <input
                      ...
                      value={generatedLink}
                      readOnly
                      className="flex-1 bg-transparent border-none outline-none text-gray-900 font-mono text-sm truncate"
                    />
                  </div>
                  <button
                    onClick={handleCopyLink}
                    className={`px-4 py-2 rounded-lg font-medium transition-all flex-shrink-0 flex items-center gap-2 ${
                      copied
                ...
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  ...
                  Content ID: <code className="bg-gray-100 px-2 py-0.5 rounded text-gray-700">{shortId}</code>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  <button
                    ...
                    className="flex flex-col items-center gap-2 p-4 bg-gray-50 hover:bg-blue-50 rounded-lg transition-colors group"
                  >
                    ...
                    <span className="text-sm font-medium text-gray-700 group-hover:text-blue-600">Twitter</span>
                  </button>
                  ...
                  <button
                    ...
                    className="flex flex-col items-center gap-2 p-4 bg-gray-50 hover:bg-green-50 rounded-lg transition-colors group"
                  >
                  ...
                  >
                    ...
                    <span className="text-sm font-medium text-gray-700 group-hover:text-gray-900">Email</span>
                  </button>
                </div>
              </div>
