    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            'Velolink charges a 35% platform margin on each transaction: 20% is taken from the creator\'s side, and 15% from the buyer\'s side, meaning creators keep 80% of their original content price per transaction.',
        },
      ],
    },
    {
