...
// Mock data for admins - will be replaced with API calls
const mockAdmins = [
  {
    id: '1',
    name: 'Sarah Johnson',
  ...
  },
  {
    ...
    email: 'emily.rodriguez@velo.com',
  ...
  },
  {
    ...
    email: 'jessica.williams@velo.com',
    role: 'Financial Admin',
    status: 'Active',
  ...
  },
  {
    ...
    email: 'robert.martinez@velo.com',
    role: 'Support Specialist',
    status: 'Invited',
    lastLogin: '-',
  },
...
export default function SuperAdminManagementPage() {
  ...
  const handleEditAdmin = (admin: typeof mockAdmins[0]) => {
    ...
    setEditForm({
      ...
      permissions: {
        ...
        creatorManagement: false,
        contentReview: false,
        financialReports: admin.role === 'Financial Admin',
        systemSettings: false,
        supportTickets: admin.role === 'Support Specialist',
      },
    });
                      ...
                      {filteredAdmins.map((admin) => (
                        <tr key={admin.id} className="border-b border-gray-100 hover:bg-gray-50">
                          ...
                          <td className="py-4 px-4 text-center">
                            <span
                              className={`inline-block px-4 py-2 rounded-lg text-sm font-medium border ${roleColors[admin.role]}`}
                            >
                              {admin.role}
                            </span>
                          </td>
                          ...
                          <td className="py-4 px-4 text-center">
                            <span className={`inline-block text-sm font-medium ${statusColors[admin.status]}`}>
                              {admin.status}
                            </span>
                          </td>
                          <td className="py-4 px-4">
                            <div className="flex items-center justify-center gap-3">
                              ...
                              <button className="text-gray-500 hover:text-red-600 transition-colors" title="Delete Admin">
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  <path
                                    strokeLinecap="round"
                                    strokeLinejoin="round"
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <span className={`inline-block px-4 py-2 rounded-lg text-sm font-medium border ${roleColors[editForm.role]}`}>
                      {editForm.role}
                    </span>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">45 days ago</p>
                    </div>
                    <button
                      type="button"
