...
import { hashPassword, generateTokenPair, getRefreshTokenExpiration, } from '../../utils/auth.js';
...
export async function registerUser(req, res) {
    try {
        ...
        try {
            ...
            await sendVerificationEmail(user.email, user.creatorProfile?.displayName || user.email, verificationToken);
        }
        catch (emailError) {
...
//# sourceMappingURL=register.post.js.map