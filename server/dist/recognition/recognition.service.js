...
let RecognitionService = RecognitionService_1 = class RecognitionService {
    ...
    async checkImageSafety(content, minConfidence = 50) {
        ...
        try {
            ...
            throw new common_1.BadRequestException(`Safety check failed: ${error.message || 'Unknown error'}`);
        }
    }
    ...
    async startVideoSafetyCheck(content, minConfidence = 50, notificationChannel) {
        ...
        try {
            ...
            throw new common_1.BadRequestException(`Video safety check failed: ${error.message || 'Unknown error'}`);
        }
    }
    async getVideoSafetyResults(jobId, nextToken) {
        ...
        try {
            ...
            throw new common_1.BadRequestException(`Failed to get results: ${error.message || 'Unknown error'}`);
        }
    }
