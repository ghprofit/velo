...
export class PaymentsService {
  ...
  async getTransactions(query: QueryPaymentsDto) {
    ...
    // If status is REJECTED, APPROVED, or PROCESSING, fetch payout requests instead
    // These statuses only exist in PayoutRequest, not Purchase
  ...
  async getPayoutRequestTransactions(query: QueryPaymentsDto) {
