<x-guest-layout>
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-gray-500">Join {{ $siteName ?? 'STRYD' }} for the best deals on sneakers</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="phone" class="block mt-1 w-full" type="tel" name="phone" :value="old('phone')" required autocomplete="tel" placeholder="0XX XXX XXXX" />
            <p class="mt-1 text-xs text-gray-500">Required for order updates and verification</p>
